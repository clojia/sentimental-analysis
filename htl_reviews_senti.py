...
data_train = pd.read_csv(TRAINING_SET, sep=',')
print(data_train.shape)

texts = []
labels = []

for idx in range(data_train.Description.shape[0]):
    texts.append(clean_str(data_train.Description[idx]))
    labels.append(gen_label(data_train.Is_Response[idx]))
